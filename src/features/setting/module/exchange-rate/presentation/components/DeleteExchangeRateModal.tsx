...
type DeleteExchangeRateProps = {
  open: boolean;
  onDelete: () => void;
  onClose: () => void;
  data: ExchangeRateType | undefined;
  isDeleting: boolean;
};

const DeleteExchangeRateDialog = (props: DeleteExchangeRateProps) => {
        ...
        <div className={cn('px-4 sm:px-6 md:px-8 pt-6 sm:pt-8 pb-4 sm:pb-6', 'flex flex-col')}>
          <div className="flex flex-col items-center mb-4 sm:mb-6">
            ...
            >
              {data && (
                <>
                  You are going to delete exchange rate from{' '}
