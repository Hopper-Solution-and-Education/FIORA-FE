...
//   const [parentAccounts, setParentAccounts] = useState<ParentAccountType[]>([]);
...
//     try {
//       const res = await fetch('/api/accounts/lists', {
//         method: 'GET',
...
//                       No matching parent accounts available
//                     </SelectItem>
//                   )}
//                 </SelectContent>
//               </Select>
          ...
          <div className="grid grid-cols-[120px_1fr] items-center gap-4">
            ...
            <div className="flex gap-2">
              <div className="border rounded w-full h-10 flex items-center px-2 bg-muted/50">
                {formData.icon ? (
                  <img src={formData.icon || '/placeholder.svg'} alt="Icon" className="h-6 w-6" />
                ) : (
