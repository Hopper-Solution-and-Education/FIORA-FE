...
import { NewsFilterValues } from '../organisms/NewsPageHeader';
...
const NewsFilterMenu = ({ categories, activeFilters, onFilterChange }: NewsFilterMenuProps) => {
  // Local filter state for the menu
  const [localFilters, setLocalFilters] = useState<NewsFilterState>({
