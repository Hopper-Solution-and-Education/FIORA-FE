...
const WarningDialog = (props: ConfirmDeleteDialogProps) => {
  const { title, content, onClose, onConfirm, open, isLoading } = props;
      ...
      >
        ...
        <div className={cn('px-4 sm:px-6 md:px-8 pt-6 sm:pt-8 pb-4 sm:pb-6', 'flex flex-col')}>
          <div className="flex flex-col items-center mb-4 sm:mb-6">
            ...
            >
              <Icons.warning
                className={cn('h-5 w-5 sm:h-6 sm:w-6', 'text-orange-300 dark:text-orange-400')}
              />
            </div>
            <DialogTitle
              className={cn(
